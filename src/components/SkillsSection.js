    ...
    <section className="skills bg-rws-light-blue p-12 flex justify-center items-center relative">
          ...
          <ul className={`flex items-center gap-8 justify-center flex-row max-w-full flex-wrap ${focusedSkill !== null ? 'blur-sm' : ''}`}>
            {skills.map((skill, index) => (
              <li
                ...
                className="flex items-center justify-center p-6 bg-white rounded-lg shadow-md transform transition-all duration-500 cursor-pointer hover:scale-105 hover:shadow-xl hover:shadow-rws-dark-blue"
              >
                <img src={skill.imgSrc} alt={skill.name} className="min-w-14" />
              </li>
            ))}
          </ul>
        </div>
      ...
      {focusedSkill !== null && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm z-50">
          <div className="bg-white p-6 rounded-lg shadow-lg transform transition-transform duration-500 text-center mx-4 min-w-[60%] max-w-[60%] max-h-[80%] overflow-auto">
            <img src={skills[focusedSkill].imgSrc} alt={skills[focusedSkill].name} className="w-16 mb-4 mx-auto" />
